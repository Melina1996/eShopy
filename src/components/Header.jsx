...
export default function Header(props) {
  return (
    <div className="h-[50dvh] w-full jungleImage bg-center bg-cover">
      <div className="h-[10dvh] flex justify-end gap-5 items-center text-white pl-[20px] text-[25px] backdrop-blur-sm	">
        <div className="hover:cursor-pointer hover:text-[#808080] hover:font-semibold  text-[15px] md:text-[18px] lg:text-[20px]">
          HOME
        </div>
        <div className="hover:cursor-pointer hover:text-[#808080] hover:font-semibold text-[15px] md:text-[18px] lg:text-[20px]">
          ABOUT
        ...
        <div className="drawer drawer-end justify-end pr-4">
          ...
          <div className="drawer-content">
            <label
              htmlFor="my-drawer-4"
              className="drawer-button btn bg-black hover:bg-[#808080] rounded-xl border-none pt-4  pb-4 btn-primary"
            >
              <img
          ...
          <div className="drawer-side">
            ...
            <ul className="menu p-4 w-100 min-h-full bg-white text-base-content">
              <Basket
                ...
                restorestock={props.restorestock}
      ...
      <div className="my-title flex justify-center items-center h-[40dvh] lg:text-[80px] md:text-[40px] text-white text-[30px] font-semibold">
        JOIN THE JUNGLE{" "}
        <span className="lg:text-[30px] md:text-[20px] md:mb-8 lg:mb-14 text-[15px] mb-6">
          &#169;
        </span>
      </div>
    </div>
