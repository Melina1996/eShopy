              ...
              return (
                ...
                <div key={id} className={`${props.quantity[id] > 0 ? "flex" : "hidden"} w-[350px] h-[150px] md:w-[450px] md:h-[200px] lg:w-[550px] lg:h-[250px] justify-center items-center`}>
                  ...
                  <div className='w-[50%] h-[100%]'>
                    <img className='w-[100%] h-[100%] object-cover rounded-lg shadow' src={
                  ...
                  <div className="flex justify-start w-[50%] h-[100%] bg-white pl-2 pr-2">
                      ...
                      <div className='h-[100%] flex flex-col justify-end pl-2 pr-2'>
                        ...
                        <div className='flex justify-start items-center gap-2 pt-2'>
                          ...
                          <button onClick={()=> {props.setMoney(props.money+(props.quantity[id]*element.price)), props.setSum(props.sum-(props.quantity[id]*element.price)),props.restorestock(id),props.deleteQuantity(id)}}><img className='w-[25px] h-[25px]' src={BIN} alt="" /></button>
