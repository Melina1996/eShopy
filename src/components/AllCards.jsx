    ...
    <div className='h-[100%] pt-10 pb-10 bg-white flex justify-center items-center flex-wrap gap-6 md:gap-10'>
      ...
      {data.map((element, id) => {
        ...
        // loop over my array with objects and create card for each of them and pass on it's ID
              return (
                <Card key={id} id={id} money={props.money} setMoney={props.setMoney} sum={props.sum} setSum={props.setSum} click={props.click} quantity={props.quantity} stock={props.stock} changeBasket={props.changeBasket} images={element.img} element={element}/>
              )
              })
          }     
